...
namespace operator_counting {
    ...
    void DeleteRelaxationConstraints::add_numeric_conditions_constraints(std::vector<lp::LPConstraint> &constraints, double infinity){
    ...
    void DeleteRelaxationConstraints::add_numeric_preconditions_constraints(std::vector<lp::LPConstraint> &constraints, double infinity){
    ...
    void DeleteRelaxationConstraints::add_numeric_goals_constraints(std::vector<lp::LPConstraint> &constraints){
    ...
    void DeleteRelaxationConstraints::add_numeric_effects_constraints(std::vector<lp::LPConstraint> &constraints, double infinity){
    ...
    void DeleteRelaxationConstraints::add_numeric_counters_constraints(std::vector<lp::LPConstraint> &constraints, double infinity){
    ...
    void DeleteRelaxationConstraints::iterative_variable_elimination(const State &state, vector<bool> &fact_eliminated, vector<bool> &action_eliminated){
    ...
    bool DeleteRelaxationConstraints::dominated_action_elimination(const State &state){
        bool changed = false;
    ...
    bool DeleteRelaxationConstraints::dominated_seq_action_elimination(const State &state){
        bool changed = false;
        // check among the relevant actions only
        for (size_t i = 0; i < numeric_task.get_n_actions(); ++i){
            if (action_eliminated[i]) continue;
    ...
    bool DeleteRelaxationConstraints::dominated_action_first_condition(int i, int j){
    ...
    bool DeleteRelaxationConstraints::numeric_condition_satisfied(int n, const State &state){
    ...
    bool DeleteRelaxationConstraints::dominated_action_second_condition(int i, int j, const State &state){
        ...
        for (int n : numeric_task.get_action_num_list(j)){
            ...
            //if ( !action_landmarks[i][p] && !numeric_condition_satisfied(n,state)) return false;
        }
    ...
    // this is state-independent, can be precomputed
    bool DeleteRelaxationConstraints::dominated_action_fourth_condition(int i, int j){
    ...
    bool DeleteRelaxationConstraints::relevant_action_reduction(const State &state){
        bool changed = false;
...
//                }
    ...
    void DeleteRelaxationConstraints::build_first_achiever(vector<set<int>> &landmarks_table){
    ...
    bool DeleteRelaxationConstraints::set_include(set<int> &first, set<int> &second){
    ...
    static PluginShared<ConstraintGenerator> _plugin("delete_relaxation_constraints", _parse);
